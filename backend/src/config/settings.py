"""
Configurações do sistema Assistente RH
"""
import os
...
class Config:
    ...
    SECRET_KEY = os.getenv('SECRET_KEY', 'assistente-rh-secret-key-2024')
    DEBUG = os.getenv('DEBUG', 'False').lower() == 'true'
    
    # Banco de dados
    DATABASE_URL = os.getenv(
        'DATABASE_URL', 
        'postgresql://assistente_rh_user:secure_password@localhost:5432/assistente_rh'
    )
    ...
    MAIL_DEFAULT_SENDER = os.getenv('MAIL_DEFAULT_SENDER', 'noreply@assistenterh.com')
    ...
    LOG_FILE = os.getenv('LOG_FILE', '/app/logs/assistente_rh.log')
...
class DevelopmentConfig(Config):
    ...
    DATABASE_URL = os.getenv(
        'DATABASE_URL', 
        'postgresql://assistente_rh_user:secure_password@localhost:5432/assistente_rh_dev'
    )
...
class TestingConfig(Config):
    ...
    DATABASE_URL = os.getenv(
        'DATABASE_URL', 
        'postgresql://assistente_rh_user:secure_password@localhost:5432/assistente_rh_test'
    )
